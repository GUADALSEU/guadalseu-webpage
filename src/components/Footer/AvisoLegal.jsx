export const AvisoLegal = () => {
  return (
    <section className='w-75 my-5'>
      ...
      <p>CONST. Y REHABILITACION GUADALSEU S.L, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), BOE N.º 166, así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.</p>
      <p>Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.</p>
      <p>CONST. Y REHABILITACION GUADALSEU S.L se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente la publicación en el sitio web de CONST. Y REHABILITACION GUADALSEU S.L.</p>
      <br />

      <h3>1. Datos identificativos</h3>
      <ul>
        <li><span className='fw-bold'>Nombre de dominio: </span>www.guadalseu.com</li>
        <li><span className='fw-bold'>Nombre comercial: </span>Guadalseu</li>
        <li><span className='fw-bold'>Denominación social: </span> CONST. Y REHABILITACIÓN GUADALSEU S.L</li>
        <li><span className='fw-bold'>NIF: </span>B25691296</li>
        <li><span className='fw-bold'>Domicilio social: </span>Avenida Antonio Machado 84 28702 San Sebastián de los Reyes MADRID</li>
        <li><span className='fw-bold'>Teléfono: </span>91 663 83 35</li>
        <li><span className='fw-bold'>E-mail: </span>administracion@guadalseu.com</li>
      </ul>
      <p>INSCRITA EN EL REGISTRO MERCANTIL DE MADRID, TOMO 33319, FOLIO 117,HOJA 599681.</p>
      <br />
      ...
      <p>Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del correo electrónico administracion@guadalseu.com.</p>
      <br />
